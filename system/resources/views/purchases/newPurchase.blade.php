                ...
                <form action="" method="post">
                    <div class="card-body " id="bar-parent">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="row">
                                    <div class="col-sm-12"><label>اسم المورد</label></div>
                                    <div class="col-sm-12">
                                        <select id="supplierID" name="supplier_id" class="form-control  select2">
                                            <option value="0">مورد إفتراضي</option>
                ...
                <div class="card-body " id="bar-parent">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input hidden id="selected_product_id">
                        </div>
                    </div>
                    <hr>
    ...
    <div class="modal fade" id="ConfirmSalePopUp" tabindex="-1" role="dialog" aria-labelledby="ConfirmSalePopUpTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ URL::to('purchases/new') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="modal-body">
                        <div id="final-recipt" >
                            ...
                            <input hidden id="f_receipt_supplier" name="supplier_id" value="" />
                            <input hidden id="f_receipt_date" name="receipt_date" value="" />
                            <table class="table">
                                <tr>
                                    <td>اسم المورد</td>
                                    <td id="final_receipt_supplier_name"></td>
                                    <td>تاريخ العملية</td>
    ...
    <script>
        $(function(){
            ...
            $(document).on('click','.btn-confirm-sale',function () {
                ...
                var supplierName    = $('#supplierID').children('option[value="'+supplierID+'"]').text();
                var receiptDate     = $('#receiptDate').val();

                $('#final_receipt_customer_name').html(supplierName);
                $('#final_receipt_date').html(receiptDate);
                $('#finalReceiptTable').html(TableRows);

                $('#f_receipt_supplier').val(supplierID);
            ...
            function load_products(keywords,number_per_page,category,page){
                ...
                $.ajax( {
                    url: "{{ URL::to('products/getAjaxPProducts') }}"+page,
                    type: "post",
                    data: {
                        keywords: keywords,
                    ...
                    success: function( data ) {
                        ...
                        $.each(products,function(i,v){
                            html += '<a href="#newProduct" data-id="'+v.id+'" data-value="'+v.value+'" data-price="'+v.purchase_price+'" '+
