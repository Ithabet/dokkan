    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="card card-box">
                ...
                <form action="{{ URL::to('products/update/'.$product->id) }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <label>نوع المنتج</label>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <select class="form-control  " name="type">
                                <option value="m" {{ ($category->type=='m') ? 'selected' : '' }}>خام</option>
                                <option value="f" {{ ($category->type=='f') ? 'selected' : '' }}>تام</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" name="name" value="{{ $product->name }}" autofocus type="text" id="txtFirstName">
                            <label class="mdl-textfield__label">اسم المنتج</label>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" name="code"  value="{{ $product->code }}" type="text" id="txtFirstName">
                            <label class="mdl-textfield__label">كود المنتج</label>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" name="sell_price" value="{{ $product->sell_price }}"  type="text" id="txtFirstName">
                            <label class="mdl-textfield__label">سعر البيع</label>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" name="purchase_price" value="{{ $product->purchase_price }}"  type="text" id="txtFirstName">
                            <label class="mdl-textfield__label">سعر التكلفة</label>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" name="quantity"  value="{{ $product->quantity }}" type="text" id="txtFirstName">
                            <label class="mdl-textfield__label">الكمية المتاحة</label>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" name="alert_quantity"  value="{{ $product->alert_quantity }}" type="text" id="txtFirstName">
