    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="card-box">
                ...
                <form action="{{ url('deposits/update/'.$deposit->id) }}" method="POST">
                    {{ csrf_field() }}
                    <div class="card-body row">
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <input class="mdl-textfield__input" name="name" value="{{ $deposit->name }}" type="text" id="txtFirstName">
                                <label class="mdl-textfield__label">عنوان الايداع</label>
                            </div>
                        </div>
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <input class="mdl-textfield__input" name="amount" value="{{ $deposit->amount }}" type="text" id="txtFirstName">
                                <label class="mdl-textfield__label">المبلغ</label>
                            </div>
                        </div>
                        <div class="col-lg-6 p-t-20">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                <input class="mdl-textfield__input" type="text" name="date" value="{{ $deposit->date }}" value="{{ date('Y-m-d') }}" id="date" data-dtp="dtp_JFOV1">
