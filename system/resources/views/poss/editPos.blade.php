    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <form action="{{ URL::to('poss/update/'.$pos->id) }}" method="post">
                    {{ csrf_field() }}
                <div class="card-body row">
                    <div class="col-lg-6 p-t-20">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" name="name" type="text" value="{{$pos->name}}" id="txtFirstName">
                            <label class="mdl-textfield__label">اسم نقطة البيع</label>
                        </div>
                    </div>
                    <div class="col-lg-6 p-t-20">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                            <input class="mdl-textfield__input" name="address" value="{{$pos->address}}" type="text" id="txtFirstName">
